...
#define REDIR_ERR 265
#define REDIR_BOTH 266
#define APPEND_OUT 267
#define APPEND_BOTH 268
...
{
       0,    60,    60,    64,    65,    69,    74,    80,    81,    85,
      92,    93,    97,   115,   124,   125,   129,   136,   139,   142,
     146,   150,   159,   162
};
#endif
...
static const char *const yytname[] =
{
  ...
  "STDOUT", "STDIN", "BACKGROUND", "REDIR_ERR", "REDIR_BOTH", "APPEND_OUT",
  "APPEND_BOTH", "$accept", "goal", "entire_command_list",
...
static const yytype_uint8 yydefact[] =
{
       ...
       3,     0,    23,     9,     7,     0,     0,    22,     0,     0,
       0,     0,    14,     0,    12,    10,    16,    17,    18,    19,
      20,    21,     5
};
...
#line 97 "shell.y" /* yacc.c:1646  */
    {
       expandWildcard(NULL,(yyvsp[0].string));
